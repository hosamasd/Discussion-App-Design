...
class OutgoingMessageCollectionViewCell: BaseCollectionCell {
    ...
    lazy var bubbleView:UIView = {
        ...
        v.layer.borderColor = UIColor.dynamicColor(.borderColor).cgColor
    ...
    override func setupViews() {
        ...
        stack(bubbleView).withMargins(.init(top: 15, left: 30, bottom: 15, right: 70))
