...
class HomeViewController: UIViewController {
    ...
    func setupViews()  {
        ...
        view.addSubViews(views: categoryView,collectionView)
              
        categoryView.anchor(top: view.topAnchor, leading: view.leadingAnchor, bottom: nil, trailing: view.trailingAnchor)
        collectionView.anchor(top: categoryView.bottomAnchor, leading: view.leadingAnchor, bottom: view.bottomAnchor, trailing: view.trailingAnchor)
